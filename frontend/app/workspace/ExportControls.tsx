    ...
    <div className="bg-slate-900 border border-slate-800 rounded-lg p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-3 w-full sm:w-auto">
        ...
        <button
          ...
          className="flex-1 sm:flex-none bg-amber-600 hover:bg-amber-500 text-white font-mono text-xs font-bold px-5 py-2.5 rounded-md transition-all shadow-md shadow-amber-950/50 disabled:opacity-50 flex items-center justify-center gap-2"
        >
