    ...
    <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 overflow-hidden">
      ...
      <div className="flex flex-wrap items-center gap-3 shrink-0 w-full lg:w-auto">
        ...
        <button
          ...
          className="flex-1 lg:flex-none bg-amber-600 hover:bg-amber-500 text-white font-mono text-xs font-bold px-5 py-2.5 rounded-md transition-all shadow-md shadow-amber-950/50 disabled:opacity-50 flex items-center justify-center gap-2 whitespace-nowrap"
        >
